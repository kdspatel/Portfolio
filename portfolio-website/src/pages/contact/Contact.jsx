...
import { RiBook2Line, RiMailLine, RiMap2Line, RiUser3Line, RiSendPlaneLine } from 'react-icons/ri';
import './contact.css';
...
const [formData , setFormData] = useState({
  ...
  const sendEmail = (e) => {
    ...
    if(!formData.name || !formData.email || !formData.subject || !formData.message) {
      ...
      setFeedbackMessage('Fill all the input fields');
    ...
    emailjs
    .send('service_o0xbrwj', 'template_hgg4h5f', formData, 'ynR0TF6L7lCEsmRYJ')
      .then(
        () => {
        ...
        <div className="contact-content grid">
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">Valsad , Gujarat , India</p>
            </div>
          </div>
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">Available</p>
            </div>
          </div>
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">kspatel6709@gmail.com</p>
            </div>
          </div>
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">+91 832 011 6436</p>
            </div>
          </div>
